...
public class BumenjingliController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		BumenjingliEntity user = bumenjingliService.selectOne(new EntityWrapper<BumenjingliEntity>().eq("bumenbianhao", username));
    ...
    public R register(@RequestBody BumenjingliEntity bumenjingli){
    	...
    	BumenjingliEntity user = bumenjingliService.selectOne(new EntityWrapper<BumenjingliEntity>().eq("bumenbianhao", bumenjingli.getBumenbianhao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,BumenjingliEntity bumenjingli, HttpServletRequest request){
