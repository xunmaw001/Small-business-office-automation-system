      ...
      <el-row>
          ...
          <el-form-item class="input" label="部门" prop="bumen">
              <el-input v-model="ruleForm.bumen" 
                placeholder="部门" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="审批项目" prop="shenpixiangmu">
          <el-input v-model="ruleForm.shenpixiangmu" 
              placeholder="审批项目" clearable  :readonly="ro.shenpixiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="审批项目" prop="shenpixiangmu">
              <el-input v-model="ruleForm.shenpixiangmu" 
                placeholder="审批项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="相关附件" prop="xiangguanfujian">
          <file-upload
          tip="点击上传相关附件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangguanfujian" label="相关附件" prop="xiangguanfujian">
            <el-button type="text" size="small" @click="download(ruleForm.xiangguanfujian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.gengxinriqi" label="更新日期" prop="gengxinriqi">
              <el-input v-model="ruleForm.gengxinriqi" 
                placeholder="更新日期" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="审批流程" prop="shenpiliucheng">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="审批流程"
                  v-model="ruleForm.shenpiliucheng" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shenpiliucheng" label="审批流程" prop="shenpiliucheng">
                    <span>{{ruleForm.shenpiliucheng}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumen = true;
            continue;
	            	            ...
	            	            if(o=='shenpixiangmu'){
            this.ruleForm.shenpixiangmu = obj[o];
	    this.ro.shenpixiangmu = true;
            continue;
          }
	            	            if(o=='shenpiliucheng'){
            this.ruleForm.shenpiliucheng = obj[o];
	    this.ro.shenpiliucheng = true;
            continue;
          }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shenpiliucheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shenpiliuchengCrossAddOrUpdateFlag = false;
                  this.parent.search();
