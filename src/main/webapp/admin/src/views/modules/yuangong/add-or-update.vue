  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
                placeholder="邮箱" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="部门编号" prop="bumenbianhao">
          <el-select  @change="bumenbianhaoChange" v-model="ruleForm.bumenbianhao" placeholder="请选择部门编号">
            <el-option
                v-for="(item,index) in bumenbianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.bumenbianhao" label="部门编号" prop="bumenbianhao">
          ...
          <el-form-item class="input" label="学历" prop="xueli">
              <el-input v-model="ruleForm.xueli" 
                placeholder="学历" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="安全等级" prop="anquandengji">
          <el-input v-model="ruleForm.anquandengji" 
              placeholder="安全等级" clearable  :readonly="ro.anquandengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="安全等级" prop="anquandengji">
              <el-input v-model="ruleForm.anquandengji" 
...
export default {
  ...
  methods: {
    ...
    bumenbianhaoChange () {
      this.$http({
        url: `follow/bumenjingli/bumenbianhao?columnValue=`+ this.ruleForm.bumenbianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.bumen){
