          ...
          <el-form-item class="input" label="员工姓名" prop="yuangongxingming">
              <el-input v-model="ruleForm.yuangongxingming" 
                placeholder="员工姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发薪月份" prop="faxinyuefen">
          <el-input v-model="ruleForm.faxinyuefen" 
              placeholder="发薪月份" clearable  :readonly="ro.faxinyuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发薪月份" prop="faxinyuefen">
              <el-input v-model="ruleForm.faxinyuefen" 
                placeholder="发薪月份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="基本工资" prop="jibengongzi">
              <el-input v-model="ruleForm.jibengongzi" 
                placeholder="基本工资" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提成" prop="ticheng">
          <el-input v-model="ruleForm.ticheng" 
              placeholder="提成" clearable  :readonly="ro.ticheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提成" prop="ticheng">
              <el-input v-model="ruleForm.ticheng" 
                placeholder="提成" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="补贴" prop="butie">
          <el-input v-model="ruleForm.butie" 
              placeholder="补贴" clearable  :readonly="ro.butie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="补贴" prop="butie">
              <el-input v-model="ruleForm.butie" 
                placeholder="补贴" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="扣款" prop="koukuan">
          <el-input v-model="ruleForm.koukuan" 
              placeholder="扣款" clearable  :readonly="ro.koukuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="扣款" prop="koukuan">
              <el-input v-model="ruleForm.koukuan" 
                placeholder="扣款" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.shifagongzi" label="实发工资" prop="shifagongzi">
              <el-input v-model="ruleForm.shifagongzi" 
                placeholder="实发工资" readonly></el-input>
                                                                                                                                        ...
                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="扣款备注" prop="koukuanbeizhu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="扣款备注"
                  v-model="ruleForm.koukuanbeizhu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.koukuanbeizhu" label="扣款备注" prop="koukuanbeizhu">
                    <span>{{ruleForm.koukuanbeizhu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  computed: {
                                                                                                    shifagongzi: {
                                                                                                                                                                                                                                                  get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.ticheng)+parseFloat(this.ruleForm.butie)-this.ruleForm.koukuan || ''
      }
    },
                      },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongxingming = true;
            continue;
	            	            ...
	            	            if(o=='faxinyuefen'){
            this.ruleForm.faxinyuefen = obj[o];
	    this.ro.faxinyuefen = true;
            continue;
          }
	            	            if(o=='jibengongzi'){
	    ...
	    this.ro.jibengongzi = true;
            continue;
	            	            ...
	            	            if(o=='ticheng'){
            this.ruleForm.ticheng = obj[o];
	    this.ro.ticheng = true;
            continue;
          }
	            	            if(o=='butie'){
            this.ruleForm.butie = obj[o];
	    this.ro.butie = true;
            continue;
          }
	            	            if(o=='koukuan'){
            this.ruleForm.koukuan = obj[o];
	    this.ro.koukuan = true;
            continue;
          }
	            	            if(o=='shifagongzi'){
	    ...
	    this.ro.shifagongzi = true;
            continue;
	            	            ...
	            	            if(o=='koukuanbeizhu'){
            this.ruleForm.koukuanbeizhu = obj[o];
	    this.ro.koukuanbeizhu = true;
            continue;
          }
	                    }
                                                                                                                                                              }
