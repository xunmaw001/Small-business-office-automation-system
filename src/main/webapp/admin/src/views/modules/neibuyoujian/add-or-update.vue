      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="主题" prop="zhuti">
          <el-input v-model="ruleForm.zhuti" 
              placeholder="主题" clearable  :readonly="ro.zhuti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主题" prop="zhuti">
              <el-input v-model="ruleForm.zhuti" 
                placeholder="主题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `neibuyoujian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.neibuyoujianCrossAddOrUpdateFlag = false;
                  this.parent.search();
