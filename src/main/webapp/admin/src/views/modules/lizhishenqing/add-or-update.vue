          ...
          <el-form-item class="input" v-if="ruleForm.shenqingriqi" label="申请日期" prop="shenqingriqi">
              <el-input v-model="ruleForm.shenqingriqi" 
                placeholder="申请日期" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="离职原因" prop="lizhiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="离职原因"
                  v-model="ruleForm.lizhiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lizhiyuanyin" label="离职原因" prop="lizhiyuanyin">
                    <span>{{ruleForm.lizhiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.bumen = true;
            continue;
	            	            ...
	            	            if(o=='lizhiyuanyin'){
            this.ruleForm.lizhiyuanyin = obj[o];
	    this.ro.lizhiyuanyin = true;
            continue;
          }
	            	            if(o=='shenqingriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lizhishenqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lizhishenqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
