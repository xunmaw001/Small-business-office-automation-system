          ...
          <el-form-item class="input" label="员工姓名" prop="yuangongxingming">
              <el-input v-model="ruleForm.yuangongxingming" 
                placeholder="员工姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="部门编号" prop="bumenbianhao">
          <el-input v-model="ruleForm.bumenbianhao" 
              placeholder="部门编号" clearable  :readonly="ro.bumenbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="部门编号" prop="bumenbianhao">
              <el-input v-model="ruleForm.bumenbianhao" 
          ...
          <el-form-item class="input" v-if="ruleForm.liuyanriqi" label="留言日期" prop="liuyanriqi">
              <el-input v-model="ruleForm.liuyanriqi" 
                placeholder="留言日期" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="留言内容" prop="liuyanneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.liuyanneirong" label="留言内容" prop="liuyanneirong">
                    <span>{{ruleForm.liuyanneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuangongxingming = true;
            continue;
	            	            ...
	            	            if(o=='bumenbianhao'){
            this.ruleForm.bumenbianhao = obj[o];
	    this.ro.bumenbianhao = true;
            continue;
          }
	            	            if(o=='bumen'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.yuangongxingming = json.yuangongxingming
                                  		...
                                  		if(json.bumenbianhao!=''&&json.bumenbianhao){
              		this.ruleForm.bumenbianhao = json.bumenbianhao
		}
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuangongliuyan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuangongliuyanCrossAddOrUpdateFlag = false;
                  this.parent.search();
