      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="经理姓名" prop="jinglixingming">
          <el-input v-model="ruleForm.jinglixingming" 
              placeholder="经理姓名" clearable  :readonly="ro.jinglixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="经理姓名" prop="jinglixingming">
              <el-input v-model="ruleForm.jinglixingming" 
                placeholder="经理姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bumenjingli/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bumenjingliCrossAddOrUpdateFlag = false;
                  this.parent.search();
